...
The file NaCl_PP_SR.mdl can be used with the TENSOAP-FAST code (https://github.com/dilkins/TENSOAP-FAST). Once this code is compiled, the model is applied by using:

/PATH/TO/TENSOAP-FAST/bin/sagpr_apply -f FRAMES.xyz -m /PATH/TO/NaCl_PP_SR.mdl -o prediction_L1.txt
...
/PATH/TO/TENSOAP-FAST/bin/sagpr_apply_process -f FRAMES.xyz -m /PATH/TO/NaCl_PP_SR.mdl -o prediction_L1.txt
