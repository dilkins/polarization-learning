...
for lm in 0 1;do
	sagpr_get_PS -f FRAMES.xyz -lm ${lm} -o PS${lm}_out -sf PS${lm} -sg 0.20 -rc 6.0 -rs 1 2.0 5 -c H O -s H O -p -l 4 -n 6
	get_atomic_power_spectrum.py -p PS${lm}_out.npy -f FRAMES.xyz -o PS${lm}_out_atomic -c O
done
sagpr_get_kernel -z 2 -ps PS1_out_atomic_O.npy PS1_active.npy -ps0 PS0_out_atomic_O.npy PS0_active.npy -s NONE NONE -o K1
